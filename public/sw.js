const CACHE_NAME = 'farmers-bracket-v1';
const urlsToCache = [
  '/',
  '/static/js/bundle.js',
  '/static/css/main.css',
...
self.addEventListener('push', function(event) {
  const options = {
    body: event.data ? event.data.text() : 'You have a new notification from Farmers Bracket!',
    icon: '/farmers.jpg',
    badge: '/farmers.jpg',
    vibrate: [100, 50, 100],
    data: {
  ...
  event.waitUntil(
    self.registration.showNotification('Farmers Bracket', options)
  );
});
